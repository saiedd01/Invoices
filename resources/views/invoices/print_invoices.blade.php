                                    ...
                                    <tr>
                                        <td class="valign-middle" colspan="2" rowspan="4">
                                            <div class="invoice-notes">
                                                <label class="main-content-label tx-13">{{$invoices->note}}</label>

                                            </div><!-- invoice-notes -->
                                        </td>
                                        <td class="tx-center">الاجمالي</td>
                                        <td class="tx-left" colspan="2"> {{ number_format($total, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-center">نسبة الضريبة ({{ $invoices->Rate_VAT }})</td>
                                        <td class="tx-left" colspan="2">{{$invoices->Value_VAT}}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-center">قيمة الخصم</td>
                                        <td class="tx-left" colspan="2"> {{ number_format($invoices->Discount, 2) }}</td>

                                    </tr>
                                    <tr>
                                        <td class="tx-center tx-uppercase tx-bold tx-inverse">الاجمالي شامل الضريبة</td>
