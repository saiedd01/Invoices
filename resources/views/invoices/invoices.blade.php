...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{url("invoices")}}">الفواتير</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    الفواتير</span>
            </div>
        </div>
    </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-contenct-between">
                        ...
                        <a href="{{url("export_invoice")}}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-download"></i>&nbsp; تصدير الفاتورة اكسيل
                        </a>
                    </div>
                </div>
                <div class="card-body">
