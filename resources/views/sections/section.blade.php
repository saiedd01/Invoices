                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">الوصف</th> {{-- description --}}
                                    <th class="border-bottom-0">العمليات</th> {{-- Created_by --}}
                            ...
                            <tbody>
                                ...
                                @foreach ($sections as $section)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ substr($section->description, 0, 50) }}{{ strlen($section->description) > 50 ? '...' : '' }}
                                        </td>
                                        <td>
                                            @can('تعديل قسم')
